...
ContextOS-Core/
|-- apps/
|   `-- desktop/             # Tauri + React + TypeScript desktop MVP
|-- contextos/
...
|   |-- token_budget/        # Greedy selector and token savings reporting
...
|-- docs/                    # Usage, limitations, desktop, performance, diagrams
...
```text
React UI -> Tauri command -> python -m contextos.cli.main -> SQLite data/desktop.db
```
...
- Separation of Concerns: parsing, storage, retrieval, desktop, and CLI orchestration remain separate
